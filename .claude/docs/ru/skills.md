...
`tausik skill install <name>` ставит по одному скиллу за раз. Для групп (integrations, data-formats, quality-pro, automation, workflow-helpers) используй **бандлы** — см. **[Skill Bundles](skill-bundles.md)**:
...
> **Убрано в v1.4:** `/go`, `/next`, `/diff`, `/onboard`, `/init` — каждый дублировал встроенную функциональность. Таблица миграции — в **[Skill Bundles Migration](skill-bundles-migration.md)**.
