...
- **`docs/research/`**, **`docs/en/research/`**, **`docs/ru/research/`** —
  технические заметки и замеры, остаются на языке, на котором написаны. Заметка
  исследования фиксирует, что кто-то измерил и когда; перевод приглашает две
  копии разъехаться, а разъехавшийся замер хуже непрочитанного. Именно поэтому
  `audit_stale_docs` исключает все три research-каталога из проверки
  зеркальности — исключение соответствует правилу, а не прикрывает пробел, и
  остаётся.
